...
class ReversiBoard:
    ...
    def flip_pieces(self,coords,checkingOnly=False):
        ...
        #key algorithm for flipping the pieces
        #go in 8 direction --> meet pieces from other player
        #eventually one piece from the current player
        #flip all pieces from the other player in between 
        #chekcingOnly serves for the get_legal_move method 
        ...
        #nested loop dr dc, delta --> change in x and y coordinate
...
class ReversiGame(Frame):
    ...
    def __init__(self,master, computerPlayer=None):
        ...
        self.rowconfigure(8,minsize=10)  # leave a little space
        #on row 8, the row between the board and the score board
        #the minzie of the rwo will be 10
        #create a little space between score and the playing board
    ...
    def update_display(self):
        ...
        # if game not over and computer player's turn
            ...
            #no waiting time between the player and the computer's move
    ...
    def get_click(self,event):
        ...
        #event.widget stores the widget that has been clicked
        
        #get the coordinate of the widget that is being clicked 
